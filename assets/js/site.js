...
const catalog = [
  ...
  ["Ultra Male", "Jean Paul Gaultier", "Importado masculino"],
  ...
  ["Bleu de Chanel", "Chanel", "Importado masculino"],
  ["Good Girl", "Carolina Herrera", "Importado feminino"],
  ["La Vie Est Belle", "Lancôme", "Importado feminino"],
  ["J'adore", "Dior", "Importado feminino"],
  ["Scandal", "Jean Paul Gaultier", "Importado feminino"],
  ["Coco Mademoiselle", "Chanel", "Importado feminino"],
  ["Black Opium", "Yves Saint Laurent", "Importado feminino"],
  ["Libre", "Yves Saint Laurent", "Importado feminino"],
  ["Olympéa", "Paco Rabanne", "Importado feminino"],
  ["Floratta Blue", "O Boticário", "Nacional feminino"],
  ["Lily", "O Boticário", "Nacional feminino"],
  ["Egeo Dolce", "O Boticário", "Nacional feminino"],
  ["Essencial", "Natura", "Nacional"],
  ["Kaiak", "Natura", "Nacional masculino"],
  ["Malbec", "O Boticário", "Nacional masculino"],
  ["Body Splash Algodão", "D'Parfum", "Outras fragrâncias"],
  ["Essência Bamboo", "D'Parfum", "Ambientes"],
  ["Reparador perfumado", "D'Parfum", "Cabelos"],
];
